...
import { PlayCircle, Microscope, Thermometer, ShieldCheck } from 'lucide-react';
        ...
        {/* <section className="bg-white py-20 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="flex items-baseline justify-between mb-12 border-b border-slate-100 pb-6">
              ...
              <span className="text-[10px] text-slate-400 uppercase tracking-widest">Showing 4 Featured Formulations</span>
            </div>
